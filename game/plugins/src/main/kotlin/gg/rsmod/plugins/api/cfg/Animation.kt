...
object Animation {
    ...
    const val MINING_DRAGON_PICKAXE_O = 8360
    const val MINING_DRAGON_PICKAXE_U = 8346
    const val MINING_DRAGON_PICKAXE_U_FLOOR = 8349
    const val MINING_DRAGON_PICKAXE_U_WALL = 335
    const val MINING_DRAGON_PICKAXE_U_WALL2 = 8344
    const val MINING_GUILDED_PICKAXE = 8358

...
enum class PickaxeType(val item: Int, val level: Int, val animation: Int) {
    ...
    DRAGON_OR_TRAILBLAZER(Items.DRAGON_PICKAXE_OR_25376, level = 61, Animation.MINING_DRAGON_PICKAXE_TRAILBLAZER),
    INFERNAL(Items.INFERNAL_PICKAXE, level = 61, Animation.MINING_INFERNAL_PICKAXE),
    INFERNAL_PICKAXE_OR(Items.INFERNAL_PICKAXE_OR, level = 61, Animation.MINING_INFERNAL_PICKAXE_O),

...
/**TODO:
 * need to check correct ids for obj and empty ores
 * BUG: DENSE_ESSENCE=> Not binding the option to object
 */
...
private val ORES = setOf(
        ...
        Ore(OreType.DAEYALT_ESSENCE, obj = 17962, emptyOreId = 0),
        ...
        Ore(OreType.AMETHYST, obj = 30371, emptyOreId = 30373),
)

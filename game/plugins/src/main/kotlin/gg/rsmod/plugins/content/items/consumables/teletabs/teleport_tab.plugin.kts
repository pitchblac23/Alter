...
private val LOCATIONS = mapOf(
    ...
    //Items.FELDIP_HILLS_TELEPORT to Area(2542, 2925, 2542, 2925),
    ...
    //Items.APE_ATOLL_TELEPORT , Need to have Monkey Madness and Receive 10th Squad Training from Daero
)

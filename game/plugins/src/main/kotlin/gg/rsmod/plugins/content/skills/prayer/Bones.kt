...
/**TODO:
 * add in ashes, ensouled heads, and shades
 * add in bone crusher 50% morytaninia diary 3 for shades
 */
enum class Bones(val id: Int, val xp: Double, val gilded: Double, val ecto: Double, val chaos: Double){
    NORMAL(Items.BONES, 4.5, 15.8, 18.0, 31.4),
    WOLF(Items.WOLF_BONES, 4.5, 15.8, 18.0, 31.4),
    BURNT(Items.BURNT_BONES, 4.5, 15.8, 18.0, 31.5),
    MONKEY(Items.MONKEY_BONES, 5.0, 17.5, 20.0, 35.0),
    BAT(Items.BAT_BONES, 5.3, 18.6, 21.2, 37.1),
    JOGRE(Items.JOGRE_BONES, 15.0, 52.5, 60.0, 105.0),
    BIG(Items.BIG_BONES, 15.0, 52.5, 60.0, 105.0),
    ZOGRE(Items.ZOGRE_BONES, 22.5, 78.8, 90.0, 157.5),
    ...
    HYDRA(Items.HYDRA_BONES, 110.0, 385.0, 440.0, 770.0),

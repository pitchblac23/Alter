package gg.rsmod.plugins.content.objs.banking.bankchest
...
CHESTS.forEach { chests ->
    on_obj_option(obj = chests, option = "use") { player.openBank() }

    on_obj_option(obj = chests, option = "collect") { open_collect(player) }
}
